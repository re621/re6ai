    ...
    for (const filter of this.entries) {
      ...
      switch (filter.type) {
        ...
        case FilterType.DirTags:
          iteration = post.tagCategoriesKnown && PostFilterUtils.compareNumbers(post.tags.director.size, value, filter.comparison);
          break;
        ...
        case FilterType.FrancTags:
          iteration = post.tagCategoriesKnown && PostFilterUtils.compareNumbers(post.tags.franchise.size, value, filter.comparison);
          break;
